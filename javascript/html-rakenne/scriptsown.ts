...
const paraFirstText = document.createTextNode(
  "Ensimmäinen kappale! Lorem wohewöghewghewgoehigöeowghewögewhgewöoghiew"
);
...
const paraSecondText = document.createTextNode(
  "Loegoewgpewhgwpghöewögiewghewöighweöiogweweölghweglwehgöewhgewöhgelghlgelgöhewlgejwhgewöghewgöewgh"
);
